...
public class datosStarter {
    ...
    private void insertDefaultUsers() {
        String sql = """
            ...
            ('Pardo', 'pardo@facturador.com', 'F4r0$K91x', '2235123456', 'Av. Colón 1234', '30123456', true, 'ADMIN'),
            ('Marcos', 'marcos@facturador.com', 'M7#qL2pN8v', '2235234567', 'San Martín 2456', '28987654', true, 'CAJERO'),
            ('Santiago', 'santiago@facturador.com', 'S9@rT4mY2', '2235345678', 'Luro 3578', '32765432', true, 'REPOSITOR'),
            ('Nico', 'nico@facturador.com', 'N8!xK5wP3z', '2235456789', 'Independencia 456', '34567890', true, 'CAJERO');        
        """;
